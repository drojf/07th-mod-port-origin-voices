    ...
    for line in lines:
        ...
        if last_line.startswith('-') and last_line.lstrip('-').strip().lower().startswith('modplayvoicels'):
            if line.startswith('+') and line.lstrip('+').strip().lower().startswith('modplayvoicels'):
                line_pairs.append((last_line[1:].rstrip(), line[1:].rstrip()))
...
settings_list = [
    ProcessSettings('onikakushi', 'C:/drojf/large_projects/umineko/HIGURASHI_REPOS/1 onikakushi', "bd2a98735890d10c365de93e9b16f71d59af662b", "72a2f10bdd0d9f4559c7345b783611cc649b4775"),
    ProcessSettings('watanagashi', 'C:/drojf/large_projects/umineko/HIGURASHI_REPOS/2 watanagashi', "c88e8b898e8876515986fd0784f67d1b920bb6b2", "729fa6a2e0a99b1ad8b9dabf8e23c1c8a98b90e2"),
    ProcessSettings('tatarigoroshi', 'C:/drojf/large_projects/umineko/HIGURASHI_REPOS/3 tatarigoroshi', "f4a894daa9f5c5353bbb65b916d6a897f1e615f5", "d9670d2b751c04164afccf7d269b05da38e50151"),
    ProcessSettings('meakashi', 'C:/drojf/large_projects/umineko/HIGURASHI_REPOS/5 meakashi', "38516d0dae8b0786e6ab8777ec86c3ab6a7659ea", "ce5073b6bf137729ddc5e15ac67a96138bef9c0f")
]
...
for conf in settings_list:
    ...
    print(f"Chapter {conf.chapter_name} had {len(replacements)} replacements at {conf.chapter_path} from {conf.before_voices_sha[0:6]}... to {conf.after_voices_sha[0:6]}...")
